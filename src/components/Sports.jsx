...
export const Sports = () => { 
    ...
    let getNews=async()=>{
        ...
        try {
            const res = await axios.get(`https://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=7d2209163e5a4832a121a9e1a561a9dd`)
            ...
            { loading? <ClipLoader color="#d7204b"
               ...
               />:news?.map((newOne)=>(
                <div className="homeSMdiv">
                    ...
                    {/* <img className="img" src={!newOne.urlToImage?"./Images/sports.jpg":newOne.urlToImage}></img> */}
